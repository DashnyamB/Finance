...
var uiController = (function() {
  ...
  return {
    ...
    displayPercentages: function(allPercentages) {
      ...
      // element bolgonii huvid zarlagin huviig massiveaas avch shivj oruulah
...
var financeController = (function() {
  ...
  return {
    tusuvTootsooloh: function() {
      ...
      calculateTotal("exp");
      // tusviig shineer tootsoolon
      data.tusuv = data.totals.inc - data.totals.exp;
      // orlogo zargagiin huviig tootsoolno
...
var appController = (function(uiController, financeController) {
  ...
  var updateTusuv = function() {
    ...
    //5. Display a calculated data on a web.
    ...
    document
      ...
      .addEventListener("click", function(event) {
        ...
        if (id) {
          ...
          // 1. Sanhuugiin modulias type, id iig ashiglaad ustgana
